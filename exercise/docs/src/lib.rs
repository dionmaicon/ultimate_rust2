...
//! ![Pumpkin Image](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/350px-FrenchMarketPumpkinsB.jpg)
...
pub struct Pumpkin {
    ...
    pub roundness: f32,
    /// `orangeness` is a number 8  to 27
    pub orangeness: i32,
}
