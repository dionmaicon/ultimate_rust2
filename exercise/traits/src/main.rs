...
fn main() {
    ...
    // 4. You prefer Maple Bacon cake. UBaconse "struct update syntax" to create a Dessert with `cake`
    ...
    let str_from = String::from(cake);

    println!("String from {:?}", str_from);
    smell_cake(&party);
